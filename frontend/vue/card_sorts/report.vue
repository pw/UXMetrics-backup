      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="lg:flex lg:items-center lg:justify-between">
          <h5 class="text-sm mb-6 lg:mb-0">
            ...
            This report can be viewed by anyone with the link (<a href="'/' + test_type + '/' + id + '/edit'" class="text-purple-600 hover:text-purple-500 transition ease-in-out duration-150">Edit</a>)
          </h5>
